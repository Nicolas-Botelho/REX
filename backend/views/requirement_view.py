...
requirement_router = APIRouter(prefix="/project/{project_id}/requirements")
...
def get_FRs(project_id: int) -> dict:
...
def create_FR(project_id: int, fr: FunctionalRequirement):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def update_FR(project_id: int, fr_id: int, fr: FunctionalRequirement):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def delete_FR(project_id: int, fr_id: int):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def get_NFRs(project_id: int) -> dict:
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def create_NFR(project_id: int, nfr: NonFunctionalRequirement):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def update_NFR(project_id: int, nfr_id: int, nfr: NonFunctionalRequirement):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def delete_NFR(project_id: int, nfr_id: int):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def get_BRs(project_id: int) -> dict:
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def create_BR(project_id: int, br: BusinessRule):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def update_BR(project_id: int, br_id: int, br: BusinessRule):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def delete_BR(project_id: int, br_id: int):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def get_requirement_questions(project_id: int) -> dict:
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def create_requirement_question(project_id: int, question: RequirementQuestion):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def update_requirement_question(project_id: int, q_id: int, question: RequirementQuestion):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
...
def delete_requirement_question(project_id: int, q_id: int):
  jg = JsonGenerator(project_id)
  data = jg.return_data()
